...
function LeftSection() {
	return (
		<aside className="flex flex-1 flex-col items-center justify-center bg-gradient-to-br from-slate-950 to-slate-800 p-8 text-center text-white md:items-start md:text-left">
